...
var ProductsController = /** @class */ (function () {
    ...
    ProductsController.prototype.insert = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var cn, params, sql;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        params = [req.body.product_name, req.body.product_detail, req.body.price, req.body.category_name, req.body.idSystemUser,
                            req.body.image_path];
                        sql = "call insert_publication(:A, :B, :C, :D, :F, :G)";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sql = "delete from publication where idpublication = :A";
                        return [4 /*yield*/, cn.exec(sql, params, function (result, err) {
                                if (err)
                                    throw err;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        cn = database_1.default.db2();
                        sql = "select p.idPublication, p.product_name, p.product_detail, p.price, pc.category_name, s.idsystemuser, s.names, s.last_name, p.publish_date, p.image_path, p.visible_publication from publication p \n        inner join product_category pc on p.idproduct_category = pc.idproduct_category\n        inner join systemUser s on p.idsystemuser = s.idsystemuser\n        where idpublication = :A";
                        params = [req.params.id];
                        return [4 /*yield*/, cn.exec(sql, params, function (result, err) {
                                if (err)
                                    throw err;
