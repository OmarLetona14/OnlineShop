...
var AscPriceController = /** @class */ (function () {
    function AscPriceController() {
    }
    AscPriceController.prototype.getAscPriceProducts = function (req, res) {
    ...
    return AscPriceController;
}());
var ascpriceController = new AscPriceController();
exports.default = ascpriceController;
