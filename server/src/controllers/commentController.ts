...
class CommentController{
    ...
    async getAllFromPublication(req:Request, res:Response){
        ...
        await cn.exec(`select cm.idComment_publication, cm.publish_date, cm.comment_content, s.idsystemuser, cm.idpublication,
    ...
    async insert(req:Request, res:Response){
        var cn = db.db2()
        let params = [req.body.comment_content, req.body.idsystemuser, req.body.idpublication]
